...
INSERT INTO Project(ProjectID, ProjectName, Value, Technologies, TechLead, clientID)
       VALUES (1,'Database Project',5155.00,'mySQL',1, 1),
       (2,'Programming Project',4120.30,'Java', 2, 2),
       (3,'API Project',11545.89,'Maven', 3, 3),
